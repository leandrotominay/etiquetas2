            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="importar.html" aria-expanded="false">
                                <i data-feather="arrow-down-right" class="feather-icon"></i>
                                <span class="hide-menu">Importar Arquivo</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="../etiquetas2/importaPlanilha.class.php" aria-expanded="false">
                                <i data-feather="play-circle" class="feather-icon"></i>
                                <span class="hide-menu">Aplique Arquivo</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="../etiquetas2/excel/apagarDoc.php" aria-expanded="false">
                                <i data-feather="x" class="feather-icon"></i>
                                <span class="hide-menu">Excluir Arquivo</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link sidebar-link" href="../etiquetas2/index.php" aria-expanded="false">
                ...
                <div class="row align-items-stretch">
                    <div class="col-xl-9 col-md-12 d-flex align-items-stretch justify-content-strech">
                        <div class="card w-100">
                            <div class="card-body">
                                <h1 class="card-title">Importe o arquivo "clientes.xlsx</h1>
...
ini_set("display_errors", 0 );
 ...
 $pdo = new PDO('mysql:host=localhost;dbname=leandrodb', 'root', '');
  
 /* Instância o objeto importação e passa como parâmetro o caminho da planilha e a conexão PDO */
 $obj = new ImportaPlanilha('./excel/clientes.xlsx', $pdo);
